...
def sum_pairs(ints, s):
    ...
    for number2 in ints:
        number1 = s - number2
        if number1 in number1_options:
            return [number1, number2]
        number1_options.add(number2)


# def sum_pairs(ints, s):
#     number1_options = set()
#     return [(s - number2, number2) if (s - number2) in number1_options else number1_options.add(number2) for number2 in ints]
